...
export const RISK_SIMPLE_QUESTIONS: RiskQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { label: 'なし',              value: 0 },
      { label: '1,000万円未満',     value: -0.5 },
      { label: '1,000〜3,000万円',  value: -1 },
      { label: '3,000〜5,000万円',  value: -1.5 },
      { label: '5,000〜7,000万円',  value: -2 },
      { label: '7,000万〜1億円未満', value: -2.5 },
      { label: '1億円以上',         value: -3 },
    ],
  },
  {
    id: 'C4',
    section: 'capacity',
    title: '5〜10年以内の大型支出予定',
    subtitle: '教育費・介護費など',
    options: [
      { label: 'なし',              value: 0 },
      { label: '500万円未満',       value: -0.5 },
      { label: '500〜700万円未満',  value: -1 },
      { label: '700〜1,000万円未満', value: -1.5 },
      { label: '1,000〜1,500万円未満', value: -2 },
      { label: '1,500万円以上',     value: -2.5 },
    ],
  },
  {
    id: 'C5',
